...
let circle1 = new Circle(100,200,50,color,1); //nivel 1
let circle2 = new Circle(480,80,50,color,1); // nivel 2
let circle3 = new Circle(50,450,50,color,1); // nivel 3
...
let square1 = new Square(250,200,100,color,2);
let square2 = new Square(50,20,100,color,2);
let square3 = new Square(300,500,100,color,2);
...
let rect1 = new Rectangle(150,350,200,100,color,3);
let rect2= new Rectangle(200,50,200,100,color,3);
let rect3 = new Rectangle(50,530,200,100,color,3);
